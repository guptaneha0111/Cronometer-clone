  ...
  return (
    <>
      ...
      >
        ...
        >
          <Box color="black" marginTop="50px">
            <Heading size={["3xl", "2xl", "2xl", "2xl"]}>Eat smarter.</Heading>
            <Heading size={["3xl", "2xl", "2xl", "2xl"]}>Live better.</Heading>
          </Box>
          <Box mt="20px" color="#4F4F52">
            <Text fontSize={["xl", "l", "l", "l"]}>
        ...
        <Box
          ...
          marginBottom="80px"
        >
          <iframe src="https://www.youtube.com/embed/4iJYKW826RQ"
           allow='fullscreen' width="90%" height="400px"/>
        </Box>
      </Flex>
        ...
        >
          <Box w={["90%", "90%", "30%"]} m={["auto", "auto", "none"]}>
            ...
            <Text fontSize={["lg", "lg", "xl"]} textAlign="center" mt="10px">
              Log meals and track all your macro and micronutrients.
            </Text>
          </Box>
          <Box w={["90%", "90%", "30%"]} m={["auto", "auto", "none"]}>
            <Box w="25%" m="auto" mb="10px">
            ...
            <Box w={["95%", "95%", "80%"]} m="auto">
              <Heading fontSize={["xl", "xl", "2xl"]} textAlign="center">
                Log meals, exercise and health metrices
              </Heading>
            </Box>
            <Text fontSize={["lg", "lg", "xl"]} textAlign="center" mt="10px">
      ...
      <Box bgColor="#262a3b" color="white">
        <Box
          w={["95%", "95%", "40%", "40%"]}
          m="auto"
          pt="70px"
      ...
      >
        ...
        >
          ...
          >
            ...
            Awesome. Getting direct feedback when you track your food really opens your eyes to what you're putting in your body. The modularity and ability to track macros,
             micros, and calories in -calories out makes this an invaluable tool for any nutritional goal.
            </Text>
            <Text fontSize="lg" mt="30px">
              Android Review
            </Text>
          ...
          <Box
            ...
            m={["auto", "auto", "none"]}
          >
            <Text fontSize={["xl", "2xl", "3xl"]} color="#005c5c">
            Whether that's bodybuilding, weight loss,
             endurance training, or just maintenance – everyone should be using Cronometer.
            </Text>
